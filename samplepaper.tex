...
\begin{figure}[t!]
  ...
  \includegraphics[width=\linewidth]{figures/exp2_scatter_v_test}
  \caption{\textbf{Problem II}, Goodness of fit, Output $y(x)$}\label{fig:problem2_fitv}
  \end{subfigure}
  ~ 
  \begin{subfigure}[t]{.5\linewidth}
  \includegraphics[width=\linewidth]{figures/exp2_scatter_t_test}
  \caption{\textbf{Problem II}, Goodness of fit, Timalag $\Delta(t)$ }\label{fig:problem2_fitt}
  \end{subfigure}
  \caption{\textbf{Problem II}, Ground truth vs Predictions}
\end{figure}


\begin{figure}[h]
\vspace{.3in}
\centerline{\includegraphics[width=0.5\textwidth]{figures/exp2_errors}}
\vspace{.3in}
...
\begin{figure}[h]
\vspace{.3in}
\centerline{\includegraphics[width=0.5\textwidth]{figures/exp2_predictive_curves}}
\vspace{.3in}
...
\begin{figure}[t!]
  ...
  \includegraphics[width=\linewidth]{figures/exp3_scatter_v_test}
  \caption{\textbf{Problem III}, Goodness of fit, Output $y(x)$}\label{fig:problem3_fitv}
  \end{subfigure}
  ~
  \begin{subfigure}[b]{.5\linewidth}
  \includegraphics[width=\linewidth]{figures/exp3_scatter_t_test}
  \caption{\textbf{Problem III}, Goodness of fit, Timalag $\Delta(t)$ }\label{fig:problem3_fitt}
  \end{subfigure}
  \caption{\textbf{Problem III}, Ground truth vs Predictions}
\end{figure}

\begin{figure}[h]
\vspace{.3in}
\centerline{\includegraphics[width=0.5\textwidth]{figures/exp3_errors}}
\vspace{.3in}
...
\begin{figure}[h]
\vspace{.3in}
\centerline{\includegraphics[width=0.5\textwidth]{figures/exp3_predictive_curves}}
\vspace{.3in}
...
\begin{figure}[h]
\vspace{.3in}
\centerline{\includegraphics[width=0.5\textwidth]{figures/exp4_scatter_v_tl}}
\vspace{.3in}
...
\begin{figure}[h]
\vspace{.3in}
\centerline{\includegraphics[width=0.5\textwidth]{figures/exp4_errors}}
\vspace{.3in}
...
\begin{figure}[h]
\vspace{.3in}
\centerline{\includegraphics[width=0.5\textwidth]{figures/exp4_predictive_curves}}
\vspace{.3in}

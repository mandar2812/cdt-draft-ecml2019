...
%
\author{Mandar Chandorkar\inst{1,2}\orcidID{0000-1111-2222-3333} \and
Cyril Furtlehner\inst{2}\orcidID{1111-2222-3333-4444} \and
Enrico Camporeale\inst{1}\orcidID{2222--3333-4444-5555} \and 
...
Springer Heidelberg, Tiergartenstr. 17, 69121 Heidelberg, France
...
(\cite{villani2009three}), \emph{Hellinger distance} (\cite{hellinger}) and \emph{Bhattacharya distance} 

...
\begin{figure*}
  ...
  \begin{subfigure}[b]{0.4\textwidth}
    ...
    \caption{ \textbf{Problem II}, Goodness of fit, Timalag $\Delta(t)$ }
...
\begin{figure*}
  ...
  \begin{subfigure}[b]{0.4\textwidth}
    ...
    \caption{ \textbf{Problem III}, Goodness of fit, Time lag $\Delta(t)$ }
...
\begin{figure*}
  ...
  \begin{subfigure}[b]{0.4\textwidth}
    ...
    \caption{ \textbf{Problem IV}, Goodness of fit, Time lag $\Delta(t)$ }
